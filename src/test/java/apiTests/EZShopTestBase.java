...
public class EZShopTestBase {
    ...
    private static final Position PRODUCT_POSITION_1 = new Position("1-1-1");
    ...
    private static final Position PRODUCT_POSITION_2 = new Position("1-1-2");
    ...
    private static final Position PRODUCT_POSITION_3 = new Position("1-1-3");
    ...
    private static final Position PRODUCT_POSITION_4 = new Position("1-1-4");
    ...
    static {
        ...
        product1.setPosition(PRODUCT_POSITION_1);
        ...
        product2.setPosition(PRODUCT_POSITION_2);
        ...
        product3.setPosition(PRODUCT_POSITION_3);
        ...
        product4.setPosition(PRODUCT_POSITION_4);
